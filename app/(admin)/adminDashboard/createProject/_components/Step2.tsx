...
import { Instruction1, Instruction2, Data } from '@/lib/interfaces';
...
const MainContainer = ({ onCreate, goBack }: MainContainerProps) => {
  const [instructions1, setInstructions1] = useState<Instruction1[]>([]);
  const [instructions2, setInstructions2] = useState<Instruction2[]>([]);
